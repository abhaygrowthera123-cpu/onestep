    ...
    return (
        <div className="min-h-screen bg-slate-50 flex font-sans">
            ...
            <aside className="hidden lg:flex flex-col w-56 bg-white border-r border-gray-100 sticky top-0 h-screen overflow-y-auto custom-scrollbar flex-shrink-0">
                <div className="p-6">
                    <Link to="/" className="flex items-center space-x-3 group">
                        <img src="/logo.png" alt="Onestep-Hub" className="w-10 h-10 xl:w-12 xl:h-12 rounded-xl object-contain shadow-md shadow-slate-100 group-hover:scale-105 transition-transform" />
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-slate-100 z-[60] flex items-center justify-between px-4">
                <Link to="/" className="flex items-center space-x-3 group">
                    <img src="/logo.png" alt="Onestep-Hub" className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg object-contain" />
                    ...
                    <>
                        ...
                        >
                            <div className="p-6 pt-20 flex items-center space-x-3">
                                <img src="/logo.png" alt="Onestep-Hub" className="w-10 h-10 rounded-xl object-contain" />
                                <div className="flex flex-col">
